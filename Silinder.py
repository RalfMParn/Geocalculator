...
class Silinder(Tk):
    def __init__(self, switch_page_callback):
        ...
        self.title("Silinder Kalkulaator")
    ...
    def calc_and_display(self):
        ...
        if valid_input:
            radius = float(self.entry1.get())
            height = float(self.entry2.get())
            volume, base_area, side_area = self.model.calculate_silinder_values(radius, height)
    ...
    def create_frame_widgets(self):
        ...
        self.selected_option.set(options[2])  # Set the default option
